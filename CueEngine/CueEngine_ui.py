...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/Res/CueEngine_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.toolBarCues = QtWidgets.QToolBar(MainWindow)
        self.toolBarCues.setMinimumSize(QtCore.QSize(0, 0))
        self.toolBarCues.setIconSize(QtCore.QSize(80, 80))
        self.toolBarCues.setObjectName("toolBarCues")
        MainWindow.addToolBar(QtCore.Qt.TopToolBarArea, self.toolBarCues)
        self.toolBarApps = QtWidgets.QToolBar(MainWindow)
        self.toolBarApps.setIconSize(QtCore.QSize(80, 80))
        self.toolBarApps.setObjectName("toolBarApps")
        MainWindow.addToolBar(QtCore.Qt.TopToolBarArea, self.toolBarApps)
        ...
        self.actionOpen_Show.setIcon(icon1)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/Res/Stage.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_Stage_Cues.setIcon(icon2)
        self.action_Stage_Cues.setObjectName("action_Stage_Cues")
        self.action_Sound_FX_Cues = QtWidgets.QAction(MainWindow)
        self.action_Sound_FX_Cues.setCheckable(True)
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/Res/SFX_300X300png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_Sound_FX_Cues.setIcon(icon3)
        self.action_Sound_FX_Cues.setObjectName("action_Sound_FX_Cues")
        self.action_Lighting_Cues = QtWidgets.QAction(MainWindow)
        self.action_Lighting_Cues.setCheckable(True)
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/Res/Lighting.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_Lighting_Cues.setIcon(icon4)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/Res/LightingApp.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_Lighting.setIcon(icon5)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/Res/MixerApp_depressed.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        icon6.addPixmap(QtGui.QPixmap(":/Res/MixerApp.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_Mixer.setIcon(icon6)
        ...
        self.action_Sound_FX.setIcon(icon7)
        self.action_Sound_FX.setObjectName("action_Sound_FX")
        self.action_Mixer_Cues = QtWidgets.QAction(MainWindow)
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/Res/mixer-icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_Mixer_Cues.setIcon(icon8)
        self.action_Mixer_Cues.setObjectName("action_Mixer_Cues")
        ...
        self.menu_View.addAction(self.action_Sound_FX_Cues)
        ...
        self.toolBarCues.addAction(self.actionOpen_Show)
        self.toolBarCues.addSeparator()
        self.toolBarCues.addAction(self.action_Stage_Cues)
        self.toolBarCues.addAction(self.action_Sound_FX_Cues)
        self.toolBarCues.addAction(self.action_Mixer_Cues)
        self.toolBarCues.addAction(self.action_Lighting_Cues)
        self.toolBarApps.addAction(self.action_Lighting)
        self.toolBarApps.addAction(self.action_Mixer)
        self.toolBarApps.addAction(self.action_Sound_FX)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.toolBarCues.setWindowTitle(_translate("MainWindow", "toolBarCues"))
        self.toolBarApps.setWindowTitle(_translate("MainWindow", "toolBarApps"))
        ...
        self.action_Sound_FX_Cues.setText(_translate("MainWindow", "S&ound FX Cues"))
        self.action_Sound_FX_Cues.setToolTip(_translate("MainWindow", "Display Sound FX Cues"))
        ...
        self.action_Mixer.setToolTip(_translate("MainWindow", "Show/hide Mixer App"))
        ...
        self.action_Sound_FX.setToolTip(_translate("MainWindow", "Show/hide Sound FX App"))
