...
logging.basicConfig(level=loglev,
                  filename=LOG_DIR + '/ShowMaker.log', filemode='w',
                  format='%(name)s %(levelname)s %(message)s')


from ShowMaker.main import main

logging.info('in show-maker.py before call to main()')
main()

logging.info('in show-maker.py after call to main()')
